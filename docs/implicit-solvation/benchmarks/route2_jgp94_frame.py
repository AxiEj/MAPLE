...
This benchmark-local module has no continuum-provider, MACE, or MAPLE parser
dependency.  It defines one local differentiable chart of the nuclear-charge
principal-axis frame for nondegenerate geometries.  Callers must fail closed
when the relative eigengap guard or the local signed-axis gauge is lost.
"""
