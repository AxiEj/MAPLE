...
| `route2-profile-diagnostic-fixedbox40-cpcm590-radialgto-electrostatic-v1` | no | no | no | no | no | one-water same-scalar Cartesian FD and six-orientation gates pass; still lacks PES panel, path/loop, box convergence, chemistry, and release evidence |
