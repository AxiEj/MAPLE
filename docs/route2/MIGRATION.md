...
| 6: force/MAPLE integration | blocked | same-scalar force is callable internally; source-bound analytic-harmonic water, methanol, ethanol, and acetone canaries pass their frozen local symmetry gates, but the complete clean 20-molecule PES/symmetry/loop and matched-component accuracy gates have not run; public calculator/workflow and admission gates remain closed |
...
These four equilibrium molecules remain far short of the complete panel.
