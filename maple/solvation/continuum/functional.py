...
reaction drive, source Hessian action, and fixed-source coordinate derivative
are then generated by :class:`ContinuumEnergyFunctional`; subclasses cannot
supply independent implementations of those derivatives.
