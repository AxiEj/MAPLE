...
field-conditioned energy.  Public capabilities remain closed until matched
chemistry, coordinate derivative and distorted-PES evidence are all bound to
this exact profile.
"""
...
class MACE_MDPPolarHybridDDXPES:
    ...
    The profile remains experimental because finite ddX exposed-node topology
    is not a global smoothness or SO(3) guarantee and chemistry admission is
    still open.
    """
