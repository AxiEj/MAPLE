...
class MACEPolarFrozenDDXEnergyState:
    ...
    def __post_init__(self) -> None:
        ...
        payload = {
            "contract": "mace-polar-frozen-ddx-energy-state-v1",
            "provider_id": self.provider_id,
...
class MACEPolarFrozenSourceDDXPES:
    ...
    def solve(self, geometry: object) -> MACEPolarFrozenDDXEnergyState:
        ...
        topology_id = canonical_metadata_sha256(
            {
                "ddx_cavity_topology_sha256": getattr(
                    continuum_state, "cavity_topology_sha256", None
                ),
    ...
    def molecular_virial(
        ...
        *,
        ...
        evaluated = (
            ...
            else force_evaluation
        )
        return evaluate_molecular_virial(
            geometry,
            evaluated.force_sample,
    ...
    def hessian_vector_product(
        ...
        *,
        ...
        center = (
            self.evaluate_forces(geometry) if central_force is None else central_force
        )
