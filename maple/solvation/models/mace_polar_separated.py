...
class MACEPolarOriginalSourceNativeFieldAdapter:
    ...
    def evaluate_energy(self, geometry: object) -> float:
        """Implement the separated vacuum-scalar provider contract."""

        return self.vacuum_energy_ev(geometry)
    ...
    def coordinate_gradient(self, geometry: object) -> np.ndarray:
        """Return ``dE_vac/dR`` in eV/angstrom from the checkpoint force."""

        return -self.vacuum_forces_ev_per_angstrom(geometry)
