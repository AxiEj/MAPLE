#!/usr/bin/env python3
"""Independently aggregate analytic-harmonic Cartesian force shards."""

from aggregate_fixedbox590_cartesian_panel import (
    _parse_args,
    aggregate_cartesian_panel,
)
from operational_analytic_harmonic_common import PROFILE_ID, SCALAR_ID
from run_operational_analytic_harmonic_cartesian_panel import (
    CONTRACT_VERSION,
    SCHEMA_VERSION as SHARD_SCHEMA_VERSION,
)

SCHEMA_VERSION = "route2-operational-analytic-harmonic-cartesian-panel-aggregate-v1"
REQUIRED_SOURCE_PATHS = (
    "tools/route2_release/aggregate_fixedbox590_pes_panel.py",
    "tools/route2_release/aggregate_fixedbox590_cartesian_panel.py",
    "tools/route2_release/aggregate_operational_analytic_harmonic_cartesian_panel.py",
...
def main() -> None:
    aggregate_cartesian_panel(
        ...
        output_marker=(
            "ROUTE2_OPERATIONAL_ANALYTIC_HARMONIC_CARTESIAN_PANEL_AGGREGATE"
        ),
    )
