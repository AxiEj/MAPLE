#!/usr/bin/env python3
"""Run full Cartesian force gates for the disabled analytic-harmonic PES."""
...
from run_fixedbox590_cartesian_panel import _parse_args, run_cartesian_panel

SCHEMA_VERSION = "route2-operational-analytic-harmonic-cartesian-panel-shard-v1"
CONTRACT_VERSION = "route2-operational-analytic-harmonic-cartesian-panel-v1"
REQUIRED_SOURCE_PATHS = COMMON_REQUIRED_SOURCE_PATHS + (
    ...
    "tools/route2_release/run_operational_analytic_harmonic_cartesian_panel.py",
)
...
def main() -> None:
    run_cartesian_panel(
        ...
        box_length=0,
        output_marker="ROUTE2_OPERATIONAL_ANALYTIC_HARMONIC_CARTESIAN_PANEL_SHARD",
        artifact_kind=("disabled-operational-analytic-harmonic-cartesian-panel-shard"),
        contract_metadata={
