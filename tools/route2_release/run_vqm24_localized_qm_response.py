...
SELF_REPO_PATH = "tools/route2_release/run_vqm24_localized_qm_response.py"
BENCHMARK_HELPER_REPO_PATH = (
    "docs/implicit-solvation/benchmarks/route2_qm_surface_mep.py"
)
BENCHMARK_DIR = SOURCE_ROOT / "docs/implicit-solvation/benchmarks"
...
def main() -> int:
    ...
    result = {
        "artifact": "route2-vqm24-qm-localized-point-charge-response-level3-v1",
        "schema_version": 1,
        "status": "success",
        ...
        "source": {
            ...
            "surface_helper_path": BENCHMARK_HELPER_REPO_PATH,
            "surface_helper_sha256": _sha256(
                SOURCE_ROOT / BENCHMARK_HELPER_REPO_PATH
            ),
        },
        "method": QM_METHOD,
        "output": {
